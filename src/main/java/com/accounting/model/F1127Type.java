...
/**
 * <p>Java class for F1127Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="F1127Type">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="cont" type="{mfp:anaf:dgti:f1127:declaratie:v1}ContType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *       &lt;attribute name="suma_control" use="required" type="{mfp:anaf:dgti:f1127:declaratie:v1}IntPoz17SType" />
 *       &lt;attribute name="d_rec" use="required" type="{mfp:anaf:dgti:f1127:declaratie:v1}IntPoz1SType" />
 *       &lt;attribute name="nume_ip" use="required" type="{mfp:anaf:dgti:f1127:declaratie:v1}Str100" />
 *       &lt;attribute name="cui_ip" use="required" type="{mfp:anaf:dgti:f1127:declaratie:v1}CuiSType" />
 *       &lt;attribute name="an" use="required" type="{mfp:anaf:dgti:f1127:declaratie:v1}IntPoz4SType" />
 *       &lt;attribute name="luna_r" use="required" type="{mfp:anaf:dgti:f1127:declaratie:v1}IntPoz2SType" />
 *       &lt;attribute name="data_document" use="required" type="{mfp:anaf:dgti:f1127:declaratie:v1}DateSType" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "F1127Type", namespace = "mfp:anaf:dgti:f1127:declaratie:v1", propOrder = {
    "cont"
})
public class F1127Type {

    @XmlElement(namespace = "mfp:anaf:dgti:f1127:declaratie:v1", required = true)
